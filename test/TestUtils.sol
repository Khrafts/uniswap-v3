...
abstract contract TestUtils is Test {
    ...
    function assertMintState(ExpectedStateAfterMint memory expected) internal view {
        assertEq(
    ...
    function assertSwapState(ExpectedStateAfterSwap memory expected) internal view {
